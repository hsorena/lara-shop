...
function(l) {
    ...
    function e(l) {
        var e = l || window.event,
            ...
            n = 0,
            s = 0;
        if ((l = o.event.fix(e)).type = "mousewheel", "detail" in e && (n = -1 * e.detail), "wheelDelta" in e && (n = e.wheelDelta), "wheelDeltaY" in e && (n = e.wheelDeltaY), "wheelDeltaX" in e && (i = -1 * e.wheelDeltaX), "axis" in e && e.axis === e.HORIZONTAL_AXIS && (i = -1 * n, n = 0), a = 0 === n ? i : n, "deltaY" in e && (a = n = -1 * e.deltaY), "deltaX" in e && (i = e.deltaX, 0 === n && (a = -1 * i)), 0 !== n || 0 !== i) {
            if (1 === e.deltaMode) {
            ...
            return s = Math.max(Math.abs(n), Math.abs(i)), (!M || s < M) && (p(e, M = s) && (M /= 40)), p(e, s) && (a /= 40, i /= 40, n /= 40), a = Math[1 <= a ? "floor" : "ceil"](a / M), i = Math[1 <= i ? "floor" : "ceil"](i / M), n = Math[1 <= n ? "floor" : "ceil"](n / M), l.deltaX = i, l.deltaY = n, l.deltaFactor = M, l.deltaMode = 0, t.unshift(l, a, i, n), c && clearTimeout(c), c = setTimeout(m, 200), (o.event.dispatch || o.event.handle).apply(this, t)
        }
    }
    ...
    var c, M, l = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"],
...
jvm.$ = jQuery, Array.prototype.indexOf || (Array.prototype.indexOf = function(l, e) {
    ...
    for (t = Math.max(0 <= n ? n : i - Math.abs(n), 0); t < i;) {
    ...
    if (this.width = l, this.height = e, this.node.style.width = l + "px", this.node.style.height = e + "px", this.node.coordsize = l + " " + e, this.node.coordorigin = "0 0", this.rootElement) {
        for (i = 0, n = (t = this.rootElement.node.getElementsByTagName("shape")).length; i < n; i++) t[i].coordsize = l + " " + e, t[i].style.width = l + "px", t[i].style.height = e + "px";
        for (i = 0, n = (a = this.node.getElementsByTagName("group")).length; i < n; i++) a[i].coordsize = l + " " + e, a[i].style.width = l + "px", a[i].style.height = e + "px"
    }
    ...
    return (l = l.replace(/(-?\d+)e(-?\d+)/g, "0")).replace(/([MmLlHhVvCcSs])\s*((?:-?\d*(?:\.\d+)?\s*,?\s*)+)/g, function(l, e, t) {
        ...
        switch (e) {
            ...
            case "V":
                return h = t[0], "l" + r + "," + h;
            case "c":
                return n = r + t[t.length - 4], s = h + t[t.length - 3], r += t[t.length - 2], h += t[t.length - 1], "v" + t.join(",");
            case "C":
                return n = t[t.length - 4], s = t[t.length - 3], r = t[t.length - 2], h = t[t.length - 1], "c" + t.join(",");
            case "s":
                return t.unshift(h - s), t.unshift(r - n), n = r + t[t.length - 4], s = h + t[t.length - 3], r += t[t.length - 2], h += t[t.length - 1], "v" + t.join(",");
            case "S":
                return t.unshift(h + h - s), t.unshift(r + r - n), n = t[t.length - 4], s = t[t.length - 3], r = t[t.length - 2], h = t[t.length - 1], "c" + t.join(",")
        }
        return ""
    }).replace(/z/g, "e")
    ...
    getValue: function(l) {
        var e, t, a = [],
            i = 0,
            n = 0;
        for ("function" == typeof this.normalize && (l = this.normalize(l)), n = 0; n < this.scale.length - 1; n++) e = this.vectorLength(this.vectorSubtract(this.scale[n + 1], this.scale[n])), a.push(e), i += e;
        for (t = (this.maxValue - this.minValue) / i, n = 0; n < a.length; n++) a[n] *= t;
        for (n = 0, l -= this.minValue; 0 <= l - a[n];) l -= a[n], n++;
        return this.vectorToNum(n == this.scale.length - 1 ? this.scale[n] : this.vectorAdd(this.scale[n], this.vectorMult(this.vectorSubtract(this.scale[n + 1], this.scale[n]), l / a[n])))
    },
    ...
    getTicks: function() {
        var l, e, t = [this.clearMinValue, this.clearMaxValue],
            ...
            n = 5 / a * i,
            s = [];
        for (n <= .15 ? i *= 10 : n <= .35 ? i *= 5 : n <= .75 && (i *= 2), t[0] = Math.floor(t[0] / i) * i, t[1] = Math.ceil(t[1] / i) * i, l = t[0]; l <= t[1];) e = l == t[0] ? this.clearMinValue : l == t[1] ? this.clearMaxValue : l, s.push({
            label: l,
    ...
    for (this.body.html(""), this.params.title && this.body.append(jvm.$("<div/>").addClass("jvectormap-legend-title").html(this.params.title)), this.body.append(n), l = 0; l < i.length; l++) {
        ...
        e.append(t), a = i[l].label, this.params.labelRender && (a = this.params.labelRender(a)), e.append(jvm.$("<div>" + a + " </div>").addClass("jvectormap-legend-tick-text")), n.append(e)
    }
    ...
    setValues: function(l) {
        ...
        if (this.scale instanceof jvm.OrdinalScale || this.scale instanceof jvm.SimpleScale)
            for (t in l) n[t] = l[t] ? this.scale.getValue(l[t]) : this.elements[t].element.style.initial[this.params.attribute];
        else {
    ...
    aea: function(l, e, t) {
        var a = t * this.radDeg,
            ...
            m = h * (r - a),
            p = Math.sqrt(o - 2 * h * Math.sin(s)) / h,
    ...
    lcc: function(l, e, t) {
        var a = t * this.radDeg,
            ...
            s = 45 * this.radDeg,
            r = l * this.radDeg,
            h = Math.log(Math.cos(n) * (1 / Math.cos(s))) / Math.log(Math.tan(Math.PI / 4 + s / 2) * (1 / Math.tan(Math.PI / 4 + n / 2))),
    ...
    lcc_inv: function(l, e, t) {
        var a = l / this.radius,
            ...
            s = 33 * this.radDeg,
            r = 45 * this.radDeg,
            h = Math.log(Math.cos(s) * (1 / Math.cos(r))) / Math.log(Math.tan(Math.PI / 4 + r / 2) * (1 / Math.tan(Math.PI / 4 + s / 2))),
    ...
    applyTransform: function() {
        var l, e, t, a;
        this.defaultWidth * this.scale <= this.width ? (l = (this.width - this.defaultWidth * this.scale) / (2 * this.scale), t = (this.width - this.defaultWidth * this.scale) / (2 * this.scale)) : (l = 0, t = (this.width - this.defaultWidth * this.scale) / this.scale), this.defaultHeight * this.scale <= this.height ? (e = (this.height - this.defaultHeight * this.scale) / (2 * this.scale), a = (this.height - this.defaultHeight * this.scale) / (2 * this.scale)) : (e = 0, a = (this.height - this.defaultHeight * this.scale) / this.scale), this.transY > e ? this.transY = e : this.transY < a && (this.transY = a), this.transX > l ? this.transX = l : this.transX < t && (this.transX = t), this.canvas.applyTransformParams(this.scale, this.transX, this.transY), this.markers && this.repositionMarkers(), this.repositionLabels(), this.container.trigger("viewportChange", [this.scale / this.baseScale, this.transX, this.transY])
    },
    bindContainerEvents: function() {
        var e, t, a = !1,
            n = this;
        this.params.panOnDrag && (this.container.mousemove(function(l) {
            return a && (n.transX -= (e - l.pageX) / n.scale, n.transY -= (t - l.pageY) / n.scale, n.applyTransform(), e = l.pageX, t = l.pageY), !1
            ...
            var e = jvm.$(n.container).offset(),
                t = l.pageX - e.left,
                a = l.pageY - e.top,
                i = Math.pow(1 + n.params.zoomOnScrollSpeed / 1e3, l.deltaFactor * l.deltaY);
            n.tip.hide(), n.setScale(n.scale * i, t, a), l.preventDefault()
        })
    },
    bindContainerTouchEvents: function() {
        var s, r, h, o, m, p, c, M = this,
            l = function(l) {
                var e, t, a, i, n = l.originalEvent.touches;
                "touchstart" == l.type && (c = 0), 1 == n.length ? (1 == c && (a = M.transX, i = M.transY, M.transX -= (h - n[0].pageX) / M.scale, M.transY -= (o - n[0].pageY) / M.scale, M.applyTransform(), M.tip.hide(), (a != M.transX || i != M.transY) && l.preventDefault()), h = n[0].pageX, o = n[0].pageY) : 2 == n.length && (2 == c ? (t = Math.sqrt(Math.pow(n[0].pageX - n[1].pageX, 2) + Math.pow(n[0].pageY - n[1].pageY, 2)) / r, M.setScale(s * t, m, p), M.tip.hide(), l.preventDefault()) : (e = jvm.$(M.container).offset(), m = n[0].pageX > n[1].pageX ? n[1].pageX + (n[0].pageX - n[1].pageX) / 2 : n[0].pageX + (n[1].pageX - n[0].pageX) / 2, p = n[0].pageY > n[1].pageY ? n[1].pageY + (n[0].pageY - n[1].pageY) / 2 : n[0].pageY + (n[1].pageY - n[0].pageY) / 2, m -= e.left, p -= e.top, s = M.scale, r = Math.sqrt(Math.pow(n[0].pageX - n[1].pageX, 2) + Math.pow(n[0].pageY - n[1].pageY, 2)))), c = n.length
            };
    ...
    bindElementEvents: function() {
        ...
        this.container.mousemove(function(l) {
            ...
            var e = -1 === (jvm.$(this).attr("class").baseVal || jvm.$(this).attr("class")).indexOf("jvectormap-region") ? "marker" : "region",
                ...
                s = jvm.$.Event(e + "Over.jvectormap");
            "mouseover" == l.type ? (r.container.trigger(s, [t]), s.isDefaultPrevented() || a.setHovered(!0), r.tip.text(i), r.container.trigger(n, [r.tip, t]), n.isDefaultPrevented() || (r.tip.show(), r.tipWidth = r.tip.width(), r.tipHeight = r.tip.height())) : (a.setHovered(!1), r.tip.hide(), r.container.trigger(e + "Out.jvectormap", [t]))
    ...
    setScale: function(l, e, t, a, i) {
        var n, s, r, h, o, m, p, c, M, d = jvm.$.Event("zoom.jvectormap"),
            u = this,
            v = 0,
            Z = Math.abs(Math.round(60 * (l - this.scale) / Math.max(l, this.scale))),
            g = new jvm.$.Deferred;
        return l > this.params.zoomMax * this.baseScale ? l = this.params.zoomMax * this.baseScale : l < this.params.zoomMin * this.baseScale && (l = this.params.zoomMin * this.baseScale), void 0 !== e && void 0 !== t && (zoomStep = l / this.scale, a ? (c = e + this.defaultWidth * (this.width / (this.defaultWidth * l)) / 2, M = t + this.defaultHeight * (this.height / (this.defaultHeight * l)) / 2) : (c = this.transX - (zoomStep - 1) / l * e, M = this.transY - (zoomStep - 1) / l * t)), i && 0 < Z ? (s = this.scale, r = (l - s) / Z, h = this.transX * this.scale, m = this.transY * this.scale, o = (c * l - h) / Z, p = (M * l - m) / Z, n = setInterval(function() {
            v += 1, u.scale = s + r * v, u.transX = (h + o * v) / u.scale, u.transY = (m + p * v) / u.scale, u.applyTransform(), v == Z && (clearInterval(n), u.container.trigger(d, [l / u.baseScale]), g.resolve())
        }, 10)) : (this.transX = c, this.transY = M, this.scale = l, this.applyTransform(), this.container.trigger(d, [l / this.baseScale]), g.resolve()), g
    },
    setFocus: function(l) {
        var e, t, a, i, n;
        if ((l = l || {}).region ? a = [l.region] : l.regions && (a = l.regions), a) {
            for (i = 0; i < a.length; i++) this.regions[a[i]] && ((t = this.regions[a[i]].element.shape.getBBox()) && (void 0 === e ? e = t : e = {
                x: Math.min(e.x, t.x),
                y: Math.min(e.y, t.y),
        ...
        return l.lat && l.lng ? (n = this.latLngToPoint(l.lat, l.lng), l.x = this.transX - n.x / this.scale, l.y = this.transY - n.y / this.scale) : l.x && l.y && (l.x *= -this.defaultWidth, l.y *= -this.defaultHeight), this.setScale(l.scale * this.baseScale, l.x, l.y, !0, l.animate)
    },
    ...
    createMarkers: function(l) {
        ...
        if (this.markersGroup = this.markersGroup || this.canvas.addGroup(), this.markerLabelsGroup = this.markerLabelsGroup || this.canvas.addGroup(), jvm.$.isArray(l))
            for (n = l.slice(), l = {}, e = 0; e < n.length; e++) l[e] = n[e];
        for (e in l) i = l[e] instanceof Array ? {
            ...
            s.container.trigger("markerSelected.jvectormap", [jvm.$(this.node).attr("data-index"), e, s.getSelectedMarkers()])
    ...
    addMarker: function(l, e, t) {
        var a, i, n = {},
            s = [];
        t = t || [];
        for (n[l] = e, i = 0; i < t.length; i++) a = {}, void 0 !== t[i] && (a[l] = t[i]), s.push(a);
        this.addMarkers(n, s)
    },
    ...
    latLngToPoint: function(l, e) {
        var t, a, i, n = jvm.Map.maps[this.params.map].projection,
            s = n.centralMeridian;
        return e < -180 + s && (e += 360), t = jvm.Proj[n.type](l, e, s), !!(a = this.getInsetForPoint(t.x, t.y)) && (i = a.bbox, t.x = (t.x - i[0].x) / (i[1].x - i[0].x) * a.width * this.scale, t.y = (t.y - i[0].y) / (i[1].y - i[0].y) * a.height * this.scale, {
            x: t.x + this.transX * this.scale + a.left * this.scale,
            y: t.y + this.transY * this.scale + a.top * this.scale
        })
    },
    pointToLatLng: function(l, e) {
        var t, a, i, n, s, r = jvm.Map.maps[this.params.map].projection,
            h = r.centralMeridian,
            o = jvm.Map.maps[this.params.map].insets;
        for (t = 0; t < o.length; t++)
            if (i = (a = o[t]).bbox, n = l - (this.transX * this.scale + a.left * this.scale), s = e - (this.transY * this.scale + a.top * this.scale), n = n / (a.width * this.scale) * (i[1].x - i[0].x) + i[0].x, s = s / (a.height * this.scale) * (i[1].y - i[0].y) + i[0].y, n > i[0].x && n < i[1].x && s > i[0].y && s < i[1].y) return jvm.Proj[r.type + "_inv"](n, -s, h);
        return !1
    },

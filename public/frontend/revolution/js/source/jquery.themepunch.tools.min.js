...
;(function (factory) {
    ...
    // CSS properties which contain references to image.
    $.waitForImages = {
        hasImageProperties: [
            'backgroundImage',
            'listStyleImage',
    ...
    // Custom selector to find image which are not already cached by the
    // browser.
    ...
    $.fn.waitForImages = function () {
        ...
        this.each(function () {
            // Build a list of all imgs, dependent on what image will
            // be considered.
            var obj = $(this);
            var allImgs = [];
            ...
            if (waitForAll) {
                ...
                obj.find('*').addBack().each(function () {
                    ...
                    $.each(hasImageAttributes, function (i, attribute) {
                        ...
                        // Check for multiple comma separated image
                ...
                // For image only, the task is simpler.
            ...
            // If no image found, don't bother.
            if (allImgsLength === 0) {
